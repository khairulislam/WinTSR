...
# Verbatim copy of utils/tools.py::normalize_scale as of commit ae3678b, inlined
# so this fixture stays self-contained and pinned even as the harness evolves.
# Note the `[0]` on amax/amin: that is the original bug this fixture exists to
# freeze, not a transcription error.
def normalize_scale(
